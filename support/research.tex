...
Harriss--Koivusalo--Walton~\cite{HarrissKoivusaloWalton2025} works in the
\emph{identical} geometry of the present manuscript ($k=2$, $d=1$, $\Gamma=\Z^2$,
physical line of slope~$\alpha$), but there the slope is irrational and the question
...
& Identical geometry ($k=2$, $d=1$, $\Z^2$), but characterises the \emph{substitutional} (quadratic-irrational) property of \emph{aperiodic} sets; the rational, periodic slope is the excluded case. No gap period.\\
