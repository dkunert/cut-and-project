...
\begin{tikzpicture}[scale=1.0,
  ...
  \begin{scope}[yshift=2.6cm]
    \draw[->] (-0.3,0) -- (7.0,0) node[right,axislabel]{\(\tilde p\)};
    \foreach \x in {0,1,2,3,4,5,6} \draw (\x,-0.08) -- (\x,0.08);
    \node[below=4pt,axislabel] at (0,-0.08) {\(0\)};
    \node[below=4pt,axislabel] at (6,-0.08) {\(D\)};
    \foreach \x/\m in {0/1, 1/1, 2/2, 3/2, 4/1, 5/1} {
      \foreach \k in {1,...,\m} {
    ...
    \node[zerolabel] at (3,1.25) {\(\delta=0\)};
    \draw[red!70!black,thin,->,>=stealth]
         (2,1.10) -- (2,\dy*2+0.10);
    \draw[red!70!black,thin,->,>=stealth]
         (3,1.10) -- (3,\dy*2+0.10);
    \node[axislabel,anchor=west] at (7.1,0.45)
         {multiset convention};
  \end{scope}
...
the \(\tilde p\)-axis (here \(D=6\), with multiplicities
\((1,1,2,2,1,1)\), so \(N=8\)).
...
\begin{tikzpicture}[scale=1.0,
  ...
  \foreach \i/\style in {%
      0/light, 1/light, 2/heavy, 3/heavy, 4/heavy, 5/heavy,
      6/light, 7/light, 8/light, 9/light, 10/light, 11/light} {
    \pgfmathsetmacro{\ang}{90 - 360*\i/12}
  ...
  \node[blue!60!black,font=\small] at (90-360*3.5/12:\R+2.6)
       {\(H\): heavy, \(\mu=q+1\)};
  \node[gray!50!black,font=\small] at (90-360*9/12:\R+1.9)
       {light, \(\mu=q\)};
...
classes.  The heavy set \(H=\{2,3,4,5\}\) is a contiguous cyclic
