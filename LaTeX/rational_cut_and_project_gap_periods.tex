...
\(-\beta\omega \le \alpha x - \beta y \le \alpha\omega\), has the same form as
...
\]
here with \(\mu = -\beta\omega\) and arithmetic thickness
...
BaakeGrimm2017, Senechal2009, Meyer1972, HaynesEtAl2016} focuses largely
on irrational slopes and aperiodic order.
Rational slopes yield periodic structures and are therefore often less
central from that perspective.  Where the rational case is treated, the
