...
paper~\cite{HarrissKoivusaloWalton2025} works in the identical planar geometry
(with \(\alpha/\beta\) replaced by an irrational slope) and asks when the resulting
aperiodic set is substitutional; the rational slope studied here is precisely the
