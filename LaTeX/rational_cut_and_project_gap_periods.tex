...
identity, which rules out any smaller period.  We also discuss the effect of
discarding multiplicities, in particular in the uniform case \(D\mid N\).
The algebraic core of the proof has been formalised in Lean~4.
\end{abstract}
