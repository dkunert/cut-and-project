...
For irrational \(a\) and \(\omega > 0\), the projected set is locally finite
and unbounded in both directions, so its gap sequence is well defined via
the increasing \(\mathbb{Z}\)-indexed enumeration of \(\tilde p(A)\).
