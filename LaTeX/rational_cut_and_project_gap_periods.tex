...
\begin{itemize}
    ...
    \item 240 additional cases generated by an independent Python
          ...
          see file \texttt{set\_theorem\_balanced\_test.csv}.
\end{itemize}
...
the projected set \(\tilde p(A)\) is locally finite and unbounded in both
directions.  Its gap sequence is therefore well defined via the increasing
