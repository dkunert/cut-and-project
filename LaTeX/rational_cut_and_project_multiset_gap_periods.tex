...
sequences are non-periodic yet highly ordered; for rational slopes they are
periodic, but explicit formulas for their period lengths are less commonly
recorded.
...
The present paper determines the period length~\(\lambda\) exactly for
rational slopes and all nonnegative real window widths in the multiset
convention specified below.  That convention is important: projected values
are counted with multiplicity throughout the main theorem.  Thus coincident
projected points can give rise to zero gaps.
