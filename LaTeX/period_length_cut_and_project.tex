...
\author{
    ...
    \and
    Gemini 3.1 Pro (High)\thanks{AI research assistant (Google). Reviewed drafts,
    identified errors in an earlier version of Lemma~4.3 and Corollary~6.4,
    and contributed to the minimality proof.}
}
\date{\today}
...
computational analysis, developed the proof structure, prepared this
manuscript, and carried out the Lean~4 formalisation
(Section~\ref{sec:lean}); it is listed as co-author accordingly.
The AI model Gemini 3.1 Pro (High) (Google) reviewed drafts of this paper,
identified errors in an earlier version of Lemma~\ref{lem:nonuniform}
and Corollary~\ref{cor:medium_omega}, and contributed to the
minimality proof (Section~\ref{subsec:step5}); it is listed as
co-author accordingly.
